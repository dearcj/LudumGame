...
define(["require", "exports", "../main"], function (require, exports, main_1) {
    ...
    var ShockwaveFilter = /** @class */ (function (_super) {
        ...
        function ShockwaveFilter() {
            var _this = _super.call(this, main_1._.rm.shaders['default.vert'], main_1._.rm.shaders['shockwave.frag'], {
                center: { type: 'v2', value: { x: 0.5, y: 0.5 } },
                params: { type: 'v3', value: { x: 10, y: 0.8, z: 0.1 } },
                time: { type: '1f', value: 1 }
            }) || this;
            _this.center = [0.27, 0.27];
            _this.params = [10, .9, 0.3];
            return _this;
        }
        ...
        Object.defineProperty(ShockwaveFilter.prototype, "params", {
            get: function () {
        ...
        Object.defineProperty(ShockwaveFilter.prototype, "time", {
            get: function () {
